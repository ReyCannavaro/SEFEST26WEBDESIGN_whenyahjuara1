    ...
    <main style={{ minHeight: '100vh', background: '#f7f7f5' }}>
      ...
      <style>{`
        ...
        @media (max-width: 1024px) {
          ...
          .vendor-badges { flex-direction: row; }
          .vendor-badge-item { flex: 1 1 130px; }
        }
        ...
        @media (max-width: 768px) {
          ...
          /* Badge: 2 per baris di 768 */
          .vendor-badges { gap: 8px; }
          .vendor-badge-item { flex: 1 1 calc(50% - 4px); padding: 9px 12px; }
        }
        ...
        @media (max-width: 480px) {
          ...
          /* Badge: tetap 2 per baris, font lebih kecil */
          .vendor-badge-item { flex: 1 1 calc(50% - 4px); padding: 8px 10px; }
          .vendor-badge-item p:first-child { font-size: 11.5px !important; }
          .vendor-badge-item p:last-child  { font-size: 10.5px !important; }
